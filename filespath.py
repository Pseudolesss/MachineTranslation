...
RAW_SENTENCES_FILE = Path("de-en.tmx")  # TMX is a specific file format for aligned corpus data (similar to XML)
SENTENCES_FILE = Path("de-en.csv")  # The Pandas Dataframe containing cleaned sentences are stored in a pickle file
...
paths = {
        RAW_SENTENCES: PROJECT_ABS_FOLDER.joinpath(DATASET_REL_FOLDER, RAW_SENTENCES_FILE),
        SENTENCES: PROJECT_ABS_FOLDER.joinpath(DATASET_REL_FOLDER, SENTENCES_FILE),
